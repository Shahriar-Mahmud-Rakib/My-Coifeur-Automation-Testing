# My Coifeur Autonomous AI Testing
...
```bash
git clone https://github.com/mejbaur-markopolo/My-Coifeur-Automation-Testing.git
cd My-Coifeur-Automation-Testing
python run.py
```
...
```
Actions → My Coifeur Autonomous AI Testing → Run workflow → browser_use: true
```
...
Go to: **Actions → My Coifeur Autonomous AI Testing → Run workflow**
